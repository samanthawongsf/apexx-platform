  ...
  const loadDashboardData = async () => {
    ...
    try {
      ...
      if (error.message.includes('Network')) {
        Alert.alert(
          'Network Error', 
          'Could not connect to server. Make sure your backend is running on localhost:3000'
        );
      }
    } finally {
      setLoading(false);
      ...
      >
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.emptyText}>
            Use the tabs below to manage your portfolios, loans, and get optimization recommendations!
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
